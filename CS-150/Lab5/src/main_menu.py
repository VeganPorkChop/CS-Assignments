"""
Last edited by Dietrich Geisler, February 2026
...
class MainMenu:
    ...
    def __init__(self):
        ...
        difficulty = tk.Frame(
            self.root, height=DIFFICULTY_HEIGHT, width=WINDOW_WIDTH)
        selection = tk.Frame(
            self.root, height=SELECTION_HEIGHT, width=WINDOW_WIDTH)
